      ...
      <>
        <div className="flex gap-y-6 flex-wrap">
          <div className="flex w-full gap-x-4 items-center">
            ...
            <div className="relative">
              ...
              <div className="text-[12px] p-0.5 inline-block rounded-md bg-gradient-to-tr from-primary to-secondary">
                <button className="px-2 rounded-md font-bold ">FREE</button>
              </div>
            </div>
          </div>
          <div className="bg-gray-900 rounded-xl px-8 py-8 w-full flex gap-y-4 flex-wrap">
          ...
          <div className="w-full flex justify-center">
            <Link
              href={"/logout"}
              className="bg-primary rounded-xl px-6 py-3 inline-block hover:bg-gray-100 duration-150"
            >
              Logout
            </Link>
          </div>
